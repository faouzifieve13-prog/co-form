        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-10 lg:gap-16">
          ...
          >
            ...
            <div className="mt-6">
              ...
              >
                <Link href="mailto:contactcoform@gmail.com">Demander un devis gratuit</Link>
              </Button>
            </div>

            <div className="mt-8 relative w-full aspect-[16/9] rounded-2xl overflow-hidden shadow-lg hidden lg:block">
              <Image
                src="/images/contact-office.jpg"
                alt="Espace de bureau professionnel"
                fill
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-foreground font-semibold">contactcoform@gmail.com</p>
              </div>
            </Link>
